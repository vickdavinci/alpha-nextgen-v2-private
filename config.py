...
ITM_V2_ADX_MIN = 15.0
ITM_V2_CALL_MAX_VIX = 22.0
ITM_V2_CALL_LOW_VIX_PREFERRED = 18.0
ITM_V2_REQUIRE_VIX20D_FALLING_FOR_CALL_WHEN_VIX_ABOVE_LOW = True
ITM_V2_PUT_MIN_VIX = 14.0
ITM_V2_PUT_MAX_VIX = 35.0
ITM_V2_BLOCK_SAME_DAY_SAME_DIRECTION_REENTRY = True
ITM_V2_BREAKER_3_LOSSES_PAUSE_DAYS = 2
ITM_V2_BREAKER_5_LOSSES_PAUSE_DAYS = 5
ITM_V2_DIRECTIONAL_BREAKER_ENABLED = True
ITM_V2_DIRECTIONAL_BREAKER_3_LOSSES_PAUSE_DAYS = 2
ITM_V2_DD_BLOCK_THRESHOLD = 0.90
ITM_V2_DD_RECOVER_THRESHOLD = 0.95
ITM_V2_DD_LOOKBACK_DAYS = 60
ITM_V2_DELTA_MIN = 0.65
ITM_V2_DELTA_MAX = 0.75
ITM_V2_DTE_MIN = 5
ITM_V2_DTE_MAX = 7
ITM_V2_TARGET_DTE = 6
ITM_V2_MAX_CONCURRENT_POSITIONS = 1
ITM_V2_MAX_CONTRACTS_HARD_CAP = 8
ITM_V2_TARGET_PCT = 0.35
ITM_V2_STOP_PCT = 0.35
ITM_V2_TRAIL_TRIGGER = 0.15
ITM_V2_TRAIL_PCT = 0.40
ITM_V2_MAX_HOLD_DAYS = 4
ITM_V2_FORCE_EXIT_DTE = 1
ITM_V2_HOLD_OVERNIGHT_ENABLED = True
