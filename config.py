...
# V12.39: Day-6 thesis review for BULL_CALL_DEBIT replaces the blunt day-4 cleanup.
# Three outcomes:
# - keep thesis when regime/tape still support the trade
# - downgrade to tactical handling when thesis is weakened but not clearly broken
# - exit only when the thesis is clearly broken by day 6
VASS_BULL_DEBIT_DAY6_THESIS_REVIEW_ENABLED = True
VASS_BULL_DEBIT_DAY6_THESIS_REVIEW_MIN_HOLD_DAYS = 6
VASS_BULL_DEBIT_DAY6_THESIS_REVIEW_TIME = "15:45"
VASS_BULL_DEBIT_DAY6_THESIS_REQUIRE_MA20 = True
VASS_BULL_DEBIT_DAY6_THESIS_KEEP_MIN_PROGRESS_PCT = 0.10
VASS_BULL_DEBIT_DAY6_THESIS_KEEP_MAX_DRAWDOWN_PCT = 0.010
VASS_BULL_DEBIT_DAY6_THESIS_EXIT_DRAWDOWN_PCT = 0.015
VASS_BULL_DEBIT_DAY6_THESIS_EXIT_MAX_PROGRESS_PCT = 0.10
