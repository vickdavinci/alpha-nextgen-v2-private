...
ITM_OVERNIGHT_WARN_LOSS_PCT = 0.12  # Stage A: warning only, keep trade open
ITM_OVERNIGHT_MED_VIX_THRESHOLD = 18.0
ITM_OVERNIGHT_HIGH_VIX_THRESHOLD = 25.0
ITM_OVERNIGHT_EOD_EXIT_LOSS_PCT_LOW_VIX = 0.18
ITM_OVERNIGHT_EOD_EXIT_LOSS_PCT_MED_VIX = 0.20
ITM_OVERNIGHT_EOD_EXIT_LOSS_PCT_HIGH_VIX = 0.24
ITM_OVERNIGHT_EOD_EXIT_REQUIRE_THESIS_BREAK = True
ITM_OVERNIGHT_EMERGENCY_LOSS_PCT = 0.30  # Always cut catastrophic overnight loss
