...
REGIME_TRANSITION_AMBIGUOUS_DETECTOR_DELTA_MAX = 0.8
REGIME_TRANSITION_RECOVERY_DELTA_MIN = 2.0
REGIME_TRANSITION_RECOVERY_DETECTOR_DELTA_MIN = 0.8
REGIME_TRANSITION_RECOVERY_MOMENTUM_MIN = 0.015
REGIME_TRANSITION_RECOVERY_VIX_5D_MAX = 0.05
REGIME_TRANSITION_DETERIORATION_DELTA_MAX = -2.0
REGIME_TRANSITION_DETERIORATION_DETECTOR_DELTA_MAX = -0.8
