...
description: "Use this agent to run QuantConnect backtests exactly as defined in docs/guides/backtest-workflow.md, including autonomous retry/fix loop, artifact pull, ObjectStore cross-check workflow, and analyzer report generation."
